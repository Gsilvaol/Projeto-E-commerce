  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <p className="font-light text-zinc-300">
        ...
        Os clientes destacam o bom custo-beneficio, a qualidade do microfone
        ...
        video dedicada. Outros destacam a qualidade do som e o conforto do fone
        de ouvido.
      </p>
